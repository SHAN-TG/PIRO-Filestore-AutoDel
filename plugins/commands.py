...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_text("<b> I'M a bot created Exclusively for the <a href='https://t.me/Moviephoria'> 𝗠𝗢𝗩𝗜𝗘 𝗣𝗛𝗢𝗥𝗜𝗔</a> Group</b> ",
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await message.reply_text(" I'M a bot created Exclusively for the <a href='https://t.me/Moviephoria'> 𝗠𝗢𝗩𝗜𝗘 𝗣𝗛𝗢𝗥𝗜𝗔</a> Group</b> ",
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
        return
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            try:
                ...
                filesarr.append(msg)
                k = await client.send_message(chat_id = message.from_user.id, text=f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u>From here forward the files to your Saved Messages and start downloading from there. From here the files will be deleted automatically</b>")
