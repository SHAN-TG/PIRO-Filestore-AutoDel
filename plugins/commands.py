...
@Client.on_message(filters.command("startmp") & filters.incoming)
async def startmp(client, message):
    ...
    if len(message.command) != 2:
        ...
        await message.reply_photo(
            ...
            caption=script.STARTMP_TXT.format(message.from_user.mention, temp.U_NAME, temp.B_NAME),
